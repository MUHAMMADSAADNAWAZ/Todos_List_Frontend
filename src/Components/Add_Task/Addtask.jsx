  ...
  return (
    ...
    <h2 className='text-white text-center p-4 text-2xl'>Add Todo Task</h2>
        <form className='flex flex-col justify-center items-center' onSubmit={handleSubmit}>
            <input name='title' ref={titleRef} type="text" placeholder='Enter todo title' className='w-[400px] p-5 my-5 border-0 outline-0 break-all' value={values.title} onChange={handleChange} onBlur={handleBlur}/>
